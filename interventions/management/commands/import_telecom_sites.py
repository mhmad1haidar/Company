...
class Command(BaseCommand):
    help = 'Import telecom sites from telecom_sites.json file'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'Found {len(sites_data)} sites in JSON file')
        ...
        self.stdout.write(self.style.SUCCESS(f'Import complete: {imported_count} new sites, {updated_count} updated sites'))
        self.stdout.write(self.style.SUCCESS(f'Total sites in database: {TelecomSite.objects.count()}'))
